...
@Component({
  standalone: true,
  imports: [FormsModule, ReactiveFormsModule, DatalistComponent, TabsComponent, NgClass, NgStyle, AgCharts, IconsModule],
...
export class CompaniesComponent implements OnInit {
  ...
  public removeCompany(): void {
    ...
    Swal.fire({
      title: this.schoolingo.locale.getLocale("traineeship/alerts/removeCompany_title"),
      text: this.schoolingo.locale.getLocale("traineeship/alerts/removeCompany_description"),
      icon: "warning",
      ...
      confirmButtonText: this.schoolingo.locale.getLocale("traineeship/removeCompany"),
      cancelButtonText: this.schoolingo.locale.getLocale("buttons/cancel"),
      reverseButtons: true
    }).then((result) => {
