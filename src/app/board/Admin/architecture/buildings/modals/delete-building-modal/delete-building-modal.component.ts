...
@Component({
  selector: 'delete-building-modal',
  standalone: true,
  ...
  template: `
    <div class="modal-body">
        <div class="danger-notice"
            ...
            <span>{{ l.s('architecture.delete_building_desc') }}</span>
        </div>
    </div>
    ...
    <div class="modal-actions"
        ...
        <button class="btn btn--danger" (click)="confirm()">
            ...
            <span>{{ l.s('architecture.delete_building_btn') }}</span>
        </button>
    </div>
  `
})
export class DeleteBuildingModalComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.data = this.modalManager.getModalData('delete-building');
  }

  public closeModal(): void {
    this.modalManager.closeModal('delete-building');
  }
