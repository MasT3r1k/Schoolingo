  ...
  template: `
    <div class="modal-body">
        <div class="danger-notice"
            ...
            <span>{{ l.s('architecture.delete_item_desc') }}</span>
        </div>
    </div>
    ...
    <div class="modal-actions"
        ...
        <button class="btn btn--danger" (click)="confirm()">
            ...
            <span>{{ l.s('architecture.delete_item_btn') }}</span>
        </button>
    </div>
  `
})
export class DeleteItemModalComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.data = this.modalManager.getModalData('delete-item');
  }

  public closeModal(): void {
    this.modalManager.closeModal('delete-item');
  }
